...
{
    [CustAuthFilter]
    public class Smx_CardHolderController : Controller
    {
        ...
        {            
            ...
            //return View(smx_CardHolder.ToList());

            List<CardHolderDisplay> smx_cardholder = new List<CardHolderDisplay>();
            if (searchString != null)
            {
                smx_cardholder = db.Smx_CardHolder.Where(s => s.Ch_Csnnumber.Contains(searchString)
